...
<nav className="navbar navbar-expand-md bg-dark sticky-top border-bottom" data-bs-theme="dark">
  <div className="container">
    ...
    <svg
        ...
        viewBox="0 0 24 24"
      >
        {/* Define your SVG content inline */}
        <symbol id="aperture" viewBox="0 0 24 24">
          <circle cx="12" cy="12" r="10" />
          <path d="M14.31 8l5.74 9.94M9.69 8h11.48M7.38 12l5.74-9.94M9.69 16L3.95 6.06M14.31 16H2.83m13.79-4l-5.74 9.94" />
        </symbol>
        {/* Use the symbol within the SVG */}
...
<main>
  ...
  <div className="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
    <div className="text-bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
      ...
      <div className="bg-body-tertiary shadow-sm mx-auto"style={divStyle}></div>
    </div>
    <div className="bg-body-tertiary me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
      ...
      <div className="bg-dark shadow-sm mx-auto"style={divStyle}></div>
    </div>
  </div>
  ...
  <div className="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
    <div className="bg-body-tertiary me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
      ...
      <div className="bg-body shadow-sm mx-auto"style={divStyle}></div>
    </div>
    <div className="bg-body-tertiary me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
      <div className="my-3 py-3">
        <h2 className="display-5">Another headline</h2>
